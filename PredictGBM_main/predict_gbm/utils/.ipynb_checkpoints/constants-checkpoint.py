...
# 返回的是  Contour/Braintumor/PredictGBM_main
...
ATLAS_T1_DIR = "data/mni152_atlas/mni_icbm152_t1_stripped.nii.gz"
ATLAS_TISSUES_DIR = "data/mni152_atlas/mni_icbm152_tissues.nii.gz"
...
#  返回 base_dir/predict_gbm_2/RHUH-0001/ses-preop
...
PATIENT_PREOP_OUTPUT_SCHEMA = (
    OUTPUT_BASE_SCHEMA / OUTPUT_FOLDER / "result" / "ses-preop"
)

# 返回    base_dir/predict_gbm_2/RHUH-0001/ses-followup


PATIENT_FOLLOWUP_OUTPUT_SCHEMA_1 = (
    OUTPUT_BASE_SCHEMA / OUTPUT_FOLDER / "result" / "ses-followup_1"
)
PATIENT_FOLLOWUP_OUTPUT_SCHEMA_2 = (
    OUTPUT_BASE_SCHEMA / OUTPUT_FOLDER / "result" / "ses-followup_2"
)


# 返回   base_dir/nifti_conversion/{modality}.nii.gz
MODALITY_CONVERTED_SCHEMA = OUTPUT_BASE_SCHEMA / CONVERSION_FOLDER / "{modality}.nii.gz"

# 返回   base_dir/skull_stripped/t1ce_bet_mask.nii.gz
BRAIN_MASK_SCHEMA =  OUTPUT_BASE_SCHEMA / SKULL_STRIP_FOLDER / "t1ce_bet_mask.nii.gz"

# 返回   base_dir/skull_stripped/brainles.log
BRAINLES_LOGFILE_SCHEMA = OUTPUT_BASE_SCHEMA / SKULL_STRIP_FOLDER / "brainles.log"

# 返回   base_dir/skull_stripped/{modality}_bet_normalized.nii.gz
MODALITY_STRIPPED_SCHEMA = (
    OUTPUT_BASE_SCHEMA / SKULL_STRIP_FOLDER / "{modality}_bet_normalized.nii.gz"
)

# 返回   base_dir/skull_stripped
...
TUMORSEG_EDEMA_SCHEMA = (
    PATIENT_PREOP_OUTPUT_SCHEMA / TUMOR_SEGMENTATION_FOLDER / "peritumoral_edema.nii.gz"
)
...
LONGITUDINAL_WARP_SCHEMA = (
    OUTPUT_BASE_SCHEMA / LONGITUDINAL_DIR / "t1ce_warped_longitudinal.nii.gz"
)
