...
from PredictGBM_main.predict_gbm.preprocessing.dicom_to_nifti import dicom_to_nifti
...
class BasePreprocessor:
    ...
    def __init__(
        ...
        if template_file is None:
            self.template_file = Path("RHUH-GBM_nii_v1/sri24_spm8/templates/T1_brain.nii")
        self.outdir = outdir
    ...
    def run(self) -> None:
        ...
        # is_coregistered=False为False这里不运行
        if self.perform_coregistration:
            ...
            norm_ss_coregister(
                ...
                # adc_file=MODALITY_CONVERTED_SCHEMA.format(
...
class NiftiPreprocessor(BasePreprocessor):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            perform_tumorseg=tumorseg_file ,
            perform_tissueseg=pre_treatment,
        )
    ...
    def run(self) -> None:
        ...
        # if self.adc_file: # 修改：如果提供了 adc_file，才将其加入字典
